const url = "https://pioneer.appfolio.com/listings/";
...
class Pioneer extends Sites {
	constructor() {
		super( url );
		this.name = "Pioneer Management";
		this.source = "pioneer";
		//this.image = "http://www.principlepm.com/wp-content/uploads/sites/1822/2015/06/logo.gif";
		this.image = "http://www.pioneerpm.com/wp-content/uploads/2013/08/cropped-copy-cropped-cropped-PioneerProperty_logo111.png";
		this.active = true;
	}
		...
		return super.execPage().then( ( $ ) => {
			...
			return Promise.each( listings, (item ) => {
				...
				let listing = {
					...
					link       : 'https://pioneer.appfolio.com' + $( item ).find( '.js-listing-title a' ).attr( 'href' ),
