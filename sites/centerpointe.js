const url = "https://centerpointepm.appfolio.com/listings/";
...
class CenterPointe extends Sites {
	constructor() {
		super( url );
		this.name = "Centre Pointe Management";
		this.source = "centerpointe";
		this.image = "http://www.cpm4rent.com/images/centerpointe_prop_mgmt_logo.png";
		//this.image = "";
		this.active = true;
	}
		...
		return super.execPage().then( ( $ ) => {
			...
			return Promise.each( listings, (item ) => {
				...
				let listing = {
					...
					link       : 'https://centerpointepm.appfolio.com' + $( item ).find( '.js-listing-title a' ).attr( 'href' ),
