const url = "https://raintreemgmt.appfolio.com/listings/";
...
class Raintree extends Sites {
	constructor() {
		super( url );
		this.name = "Raintree Management Inc.";
		this.source = "raintree";
		...
		return super.execPage().then( ( $ ) => {
			...
			return Promise.each( listings, (item ) => {
				...
				let listing = {
					...
					link       : 'https://raintreemgmt.appfolio.com' + $( item ).find( '.js-listing-title a' ).attr( 'href' ),
